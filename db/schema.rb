...
ActiveRecord::Schema.define(version: 20140817052511) do
  ...
  create_table "submission_composites", force: true do |t|
  ...
  create_table "submission_pictures", force: true do |t|
    t.integer  "submission_id"
